...
import static ua.org.tees.yarosh.tais.ui.core.api.DataBinds.UriFragments.Student.SCHEDULE;
import static ua.org.tees.yarosh.tais.ui.views.student.api.ScheduleTaisView.SchedulePresenter;
...
public class ScheduleViewStudent extends DashboardView implements ScheduleTaisView {
    ...
    public void update() {
        ...
        SchedulePresenter presenter = UIFactory.getCurrent().getRelativePresenter(this, SchedulePresenter.class);
    ...
    private void updateLessons() {
        Map<? extends Date, ? extends List<Lesson>> schedule = UIFactory.getCurrent()
