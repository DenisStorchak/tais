...
@TaisPresenter
public class ScheduleListenerStudent extends AbstractPresenter implements ScheduleTaisView.SchedulePresenter {
    ...
    @Autowired
    public ScheduleListenerStudent(@Qualifier(SCHEDULE) Updateable view) {
        super(view);
    }
