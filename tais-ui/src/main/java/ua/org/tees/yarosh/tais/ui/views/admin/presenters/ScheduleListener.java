...
@TaisPresenter
public class ScheduleListener extends AbstractPresenter implements ScheduleTais.SchedulePresenter {
    ...
    @Autowired
    public ScheduleListener(@Qualifier(MANAGED_SCHEDULE) Updatable view) {
        super(view);
    }
